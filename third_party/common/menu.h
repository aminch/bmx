...
typedef enum {
   ...
   MENU_LICENSE_TCPSER,
   MENU_LICENSE_CCGMS,
   MENU_LICENSE_BROADCOM,
   MENU_LICENSE_LINUX,
   MENU_LICENSE_THIRD_PARTY,
   MENU_ATTACH_DISK_8,
   MENU_ATTACH_DISK_9,
   MENU_ATTACH_DISK_10,
   MENU_ATTACH_DISK_11,
   ...
   // Relative to _0_. Keep together.
   MENU_USB_0_MAPPING_MODE,
   MENU_USB_1_MAPPING_MODE,
   MENU_USB_2_MAPPING_MODE,
   MENU_USB_3_MAPPING_MODE,
   // Relative to _0_. Keep together.
   MENU_USB_0_X_AXIS,
   MENU_USB_1_X_AXIS,
   MENU_USB_2_X_AXIS,
   ...
   MENU_SID_RESID_6581_PASSBAND, // VICE
   MENU_SID_RESID_6581_GAIN, // VICE
   MENU_SID_RESID_6581_FILTER_BIAS, // VICE
   MENU_SID_RESID_8580_PASSBAND, // VICE
   MENU_SID_RESID_8580_GAIN, // VICE
   MENU_SID_RESID_8580_FILTER_BIAS, // VICE

   MENU_SID2_ENABLE, // VICE
   MENU_SID2_ADDRESS, // VICE
   MENU_SID2_MODEL, // VICE
   MENU_SID2_FILTER, // VICE
   MENU_SID2_RESID_6581_PASSBAND, // VICE
   MENU_SID2_RESID_6581_GAIN, // VICE
   MENU_SID2_RESID_6581_FILTER_BIAS, // VICE
   MENU_SID2_RESID_8580_PASSBAND, // VICE
   MENU_SID2_RESID_8580_GAIN, // VICE
   MENU_SID2_RESID_8580_FILTER_BIAS, // VICE

   MENU_SOUND_EMULATION, // VICE
   MENU_SOUND_WARP_MODE, // VICE
   MENU_DATASETTE_SOUND, // VICE
   MENU_DATASETTE_SOUND_VOLUME, // VICE
   MENU_AUDIO_LEAK_VICII, // VICE
   MENU_AUDIO_LEAK_VDC, // VICE
   MENU_AUDIO_LEAK_VIC, // VICE
   MENU_AUDIO_LEAK_TED, // VICE
   MENU_AUDIO_LEAK_CRTC, // VICE
   ...
   MENU_NETWORK_ADAPTER,
   MENU_NETWORK_DHCP,
   MENU_NETWORK_IP,
   MENU_NETWORK_NETMASK,
   MENU_NETWORK_GATEWAY,
   MENU_NETWORK_DNS,
   MENU_NETWORK_WIFI_SSID,
   MENU_NETWORK_WIFI_AP_SELECT,
   MENU_NETWORK_WIFI_PSK,
   MENU_NETWORK_WIFI_COUNTRY,
   MENU_RS232NET_ENABLE,
   MENU_RS232NET_MODE,
   MENU_RS232NET_INTERFACE,
   MENU_RS232NET_TARGET,
   MENU_RS232NET_BAUD,
   MENU_RS232NET_IP232,
...
// Used as indices
typedef enum {
   KEYBOARD_MAPPING_POS = 0,
   KEYBOARD_MAPPING_POS_DE,
